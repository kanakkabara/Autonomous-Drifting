...
int throttle;       // Throttle value between 0 and 180.
int steeringAngle;  // Steering angle between 0 and 180.
...
//      case 'l':
//        Serial.print("J");
//        steeringAngle -= STEERING_ANGLE_STEP;  // Steer left.
//        break;
//      case 'j':
//        
//        steeringAngle += STEERING_ANGLE_STEP;  // Steer right.
//        break;
//      case 'i':
//        
//        throttle += THROTTLE_STEP;             // Increase throttle.
//        break;
//      case 'k':
//        throttle -= (2*THROTTLE_STEP);             // Decrease throttle.
//        break;
//      case 'p':
//        throttle = 0;
////      default:
////        throttle = 80;   // Stop moving.
////        steeringAngle = 90; // Steer straight.
//    }
//  }
...
//      Serial.println( typeid(yaw).name() );
      payload[0] = (uint8_t) 17;
      payload[1] = (uint8_t) 17;
      payload[2] = (uint8_t) 17;
      xbee.send(tx);
...
void interruptHandler(){
  if (digitalRead(x1) == digitalRead(x2)) x--;
  else if(digitalRead(x1) != digitalRead(x2)) x++;
}
